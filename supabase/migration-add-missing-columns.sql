...
DELETE FROM users WHERE id != '30000000-0000-0000-0000-000000000001';
INSERT INTO users (id, name, role, outlet_id, pin)
SELECT '30000000-0000-0000-0000-000000000001', 'Sabana', 'admin', '00000000-0000-0000-0000-000000000001', '080802'
ON CONFLICT (id) DO UPDATE SET name = 'Sabana', role = 'admin', pin = '080802';
